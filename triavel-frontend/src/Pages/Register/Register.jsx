    ...
    return(
        <>
            ...
            <div className="flex flex-col items-center">
                ...
                <img src={Recresgblu} className="absolute z-[3] h-full  w-full animate-fade-up lg:hidden right-3 bottom-[4%]"/>
                ...
                <img src={Recresgor} className="absolute z-[3] h-full w-full lg:h-[95%] right-0 bottom-[4%] lg:bottom-0 lg:w-[55%] animate-fade-up"/>
