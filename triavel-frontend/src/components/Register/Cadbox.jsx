                ...
                <div className={"w-[75%] h-[70%] bg-primary mt-35 lg:mt-100 lg:rounded-[80px] rounded-[15px] flex flex-col lg:block items-center lg:p-30 " + ClassName}>
                    <div className="lg:flex lg:flex-row ">
                        <div className="lg:w-[100%] flex flex-col items-center ">
                            ...
                            <input type="text" value={nome} onChange={(e)=>{setNome(e.target.value)}} className=" outline-none transition-transform ease-in-out hover:scale-105 lg:w-[85%] w-[85%] lg:h-[20%] h-[5%] lg:p-2 p-3 lg:rounded-[60px] rounded-[10px] lg:mt-[2%] mt-1 bg-gray-300 lg:text-[70px] text-[15px] lg:placeholder:text-[70px] placeholder:text-[15px] placeholder:font-inter placeholder:text-sencundary-color" placeholder="Informe seu nome"/>
                            ...
                            <button onClick={()=>{RegistrarGoogle()}} className="lg:hidden flex p-2 items-center justify-center lg:gap-10 gap-3 lg:w-[40%] w-[70%] lg:h-[30%] h-[5%] lg:mt-20 mt-3 relative z-[70] bg-terciary border border-gray-300 lg:rounded-[40px] rounded-[10px] hover:bg-amber-700  transition-colors">
                                ...
                                <span className="font-inter text-white lg:text-[500%] p-1 text-[70%]">Cadastrar com Google</span>
                            </button>
                        </div>
